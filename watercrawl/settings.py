...
SCRAPY_CONCURRENT_REQUESTS = env('SCRAPY_CONCURRENT_REQUESTS', cast=int, default=32)
SCRAPY_DOWNLOAD_DELAY = env('SCRAPY_DOWNLOAD_DELAY', cast=float, default=0)
SCRAPY_CONCURRENT_REQUESTS_PER_DOMAIN = env('SCRAPY_CONCURRENT_REQUESTS_PER_DOMAIN', cast=int, default=16)
SCRAPY_CONCURRENT_REQUESTS_PER_IP = env('SCRAPY_CONCURRENT_REQUESTS_PER_IP', cast=int, default=16)

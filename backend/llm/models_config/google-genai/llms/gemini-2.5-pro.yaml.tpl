...
parameter_rules:
  ...
  - name: thinking_budget
    type: integer
    label: "{% trans 'Set thinking budget' %}"
    help: "{% trans 'Indicates the thinking budget in tokens. This value is valid only when thinking mode is enabled. The default values and allowed ranges are model dependent. If the thinking budget is not set, the default is to enable dynamic budget reasoning.' %}"
    required: false
    default: 8192
    min: 128
    max: 32768

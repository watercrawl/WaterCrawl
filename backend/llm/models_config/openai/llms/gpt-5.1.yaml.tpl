...
parameter_rules:
  ...
  - name: reasoning_effort
    ...
    type: string
    help: "{% trans 'Constrains effort on reasoning for reasoning models. Currently supported values are none, low, medium, and high. Reducing reasoning effort can result in faster responses and fewer tokens used on reasoning in a response. The default for GPT-5.1 is none.' %}"
    required: false
    default: none
    options:
      - none

...
|----------|---------------|-------------|
| `VERSION` | `v0.11.1`     | Application version. Always check [GitHub Releases](https://github.com/watercrawl/WaterCrawl/releases) for the latest version |
...
```bash
# Core Settings
VERSION=v0.11.1  # Check https://github.com/watercrawl/WaterCrawl/releases for latest version
NGINX_PORT=80

...
export const CookieConsentBanner: React.FC = () => {
    ...
    return (
        <>
            {!isModalOpen && <div
                className={'fixed bottom-4 start-4 end-4 flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-0 sm:justify-between p-4 rounded-lg shadow-lg transition-all duration-300 ease-in-out bg-white dark:bg-gray-800 text-black dark:text-white border border-gray-200 dark:border-gray-700 z-[100]'}
            >
                ...
                <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                    ...
                    >
                        <CheckCircle className="w-4 h-4 me-2 shrink-0" />

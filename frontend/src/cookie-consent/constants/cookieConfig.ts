...
export const COOKIE_CATEGORIES: CookieCategory[] = [
  ...
  },
  {
    ...
    description:
      'These cookies are used to track visitors across websites to provide more relevant advertising and content.',
    essential: false,
  },
];
...
export const validateCookieConsent = (consent: any): string[] => {
  ...
  return consent.categories.filter(
    (cat: string) => validCategories.includes(cat) || cat === 'necessary'
  );
};

...
export function initSentry() {
  ...
  Sentry.init({
    ...
    tracesSampleRate:
      cfg?.SENTRY_TRACES_SAMPLE_RATE || import.meta.env.VITE_SENTRY_TRACES_SAMPLE_RATE,
    replaysSessionSampleRate:
      cfg?.SENTRY_REPLAYS_SESSION_SAMPLE_RATE ||
      import.meta.env.VITE_SENTRY_REPLAYS_SESSION_SAMPLE_RATE,
    replaysOnErrorSampleRate:
      cfg?.SENTRY_REPLAYS_ON_ERROR_SAMPLE_RATE ||

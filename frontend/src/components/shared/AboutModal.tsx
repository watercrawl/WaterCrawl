      ...
      <Dialog as="div" className="relative z-50" onClose={onClose}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-sm transform overflow-hidden rounded-lg bg-card p-5 text-start align-middle shadow-xl ring-1 ring-border transition-all">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-1.5">
                    <a
                      ...
                      className="flex items-center justify-between rounded-md px-3 py-2 text-xs font-medium text-foreground transition-colors hover:bg-muted"
                    >

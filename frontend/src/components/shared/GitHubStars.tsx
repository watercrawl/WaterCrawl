  ...
  return (
    <div className={`overflow-hidden rounded-lg border border-blue-800/30 bg-blue-900/20 shadow-md hover:shadow-lg transition-shadow ${className}`}>
      <div className="px-4 py-3">
        <h3 className="text-sm font-medium text-blue-100 drop-shadow">Support WaterCrawl</h3>
        <p className="mt-1 text-xs text-blue-300">
          If you find WaterCrawl useful, please consider giving us a star on GitHub!
        </p>
      </div>

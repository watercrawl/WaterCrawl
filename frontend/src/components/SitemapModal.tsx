...
const SitemapModal: React.FC<SitemapModalProps> = ({
  ...
  const loadMarkdownContent = useCallback(async () => {
    ...
    try {
      ...
      setMarkdownContent('Error loading markdown content. Please try again.');
    } finally {
  ...
  const handleDownloadSitemap = (format: 'graph' | 'markdown') => {
    ...
    try {
      ...
      toast.error(`Failed to download sitemap as ${format}`);
    }
  };
                ...
                <div>
                  <div className="flex justify-between items-center mb-4">
                    ...
                    <div className="flex space-x-2 mr-6">
                      ...
                      >
                        <MapIcon className="h-4 w-4 mr-1.5 text-blue-600 dark:text-blue-400" />
                        JSON Sitemap
                      </button>
                      ...
                      >
                        <DocumentArrowDownIcon className="h-4 w-4 mr-1.5 text-blue-600 dark:text-blue-400" />
                        JSON Graph
                      </button>
                      ...
                      >
                        <DocumentTextIcon className="h-4 w-4 mr-1.5 text-green-600 dark:text-green-400" />
                        Markdown
                      </button>
                    </div>
                  </div>

...
import type { AgentTool, ToolParameterStrategy, ToolParameterStrategyConfig, ToolParametersConfig } from '../../types/agent';
import type { JSONSchemaDefinition } from '../json-forms/types/schema';

interface ToolParameterStrategyModalProps {
  isOpen: boolean;
  onClose: () => void;
  tool: AgentTool;
...
export const ToolParameterStrategyModal: React.FC<ToolParameterStrategyModalProps> = ({
  isOpen,
  onClose,
  tool,
  onSave,
  ...
  const existingConfig = tool.config as ToolParametersConfig | undefined;
  ...
  const initialParamsConfig = useMemo((): Record<string, ToolParameterStrategyConfig> => {
    ...
    const inputSchema = tool.tool.input_schema as JSONSchemaDefinition | undefined;
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <button
                type="button"
                onClick={() => setFunctionName(tool.tool.key)}
          ...
          <div>
            <div className="flex items-center justify-between mb-1.5">
              ...
              <button
                type="button"
                onClick={() => setDescription(tool.tool.description || '')}
            ...
            <textarea
              ...
              placeholder={tool.tool.description}
              rows={4}
            ...
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                ...
                <code className="text-xs font-medium text-foreground">
                  {functionName.trim() || tool.tool.key}
                </code>
              </div>
              <div className="flex items-start gap-2 flex-col">
                ...
                <div className="flex-1 border-border bg-muted p-2 rounded w-full overflow-hidden">
                  <MarkdownRenderer
                    content={description.trim() || tool.tool.description || t('agents.toolConfig.noDescription')}
...
export default ToolParameterStrategyModal;

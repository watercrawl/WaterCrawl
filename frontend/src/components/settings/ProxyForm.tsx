...
const ProxyForm: React.FC<ProxyFormProps> = ({
  ...
  return (
    <Modal
      isOpen={isOpen}
      onClose={onClose}
      title={initialData ? t('settings.proxy.editTitle') : t('settings.proxy.createTitle')}
      ...
      footer={
        <>
          ...
          <Button type="submit" form="proxy-form" disabled={loading} loading={loading}>
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className={`mt-1 block w-full rounded-lg border bg-input text-foreground shadow-sm focus:border-primary focus:ring-1 focus:ring-primary sm:text-sm ${errors.name ? 'border-error' : 'border-input-border'}`}
          ...
          <div>
            <label htmlFor="proxy_type" className="block text-sm font-medium text-foreground">
            ...
            {errors.proxy_type && <p className="mt-1 text-sm text-error">{errors.proxy_type}</p>}
          </div>
            ...
            {initialData ? (
              ...
              <div>
                ...
                <div className="mb-3 flex items-center">
                  ...
                  />
                  <label htmlFor="keep_password" className="ms-2 block text-sm text-foreground">
                ...
                {initialData.has_password && (
                  <div className="mb-3 flex items-center">
                    <input
                      ...
                      className="rounded-full border-input-border text-primary focus:ring-primary"
                    />
                    <label htmlFor="remove_password" className="ms-2 block text-sm text-foreground">
                ...
                <div className="mb-3 flex items-center">
                  <input
                    ...
                    className="rounded-full border-input-border text-primary focus:ring-primary"
                  />
                  <label htmlFor="set_password" className="ms-2 block text-sm text-foreground">
                    {initialData.has_password
